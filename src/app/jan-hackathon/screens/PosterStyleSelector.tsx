  ...
  const tempateStyle = [
    {
      ...
      hookline: {
        style:
          "text-left !text-[#333333] text-[20px] font-[700] leading-[28px] uppercase pb-3",
      },
      description: {
        isVisible: true,
        style:
          "text-left !text-[#333333] text-[10.24px] font-[500] leading-[16px] tracking-[1.28]  uppercase",
      },
    },
    {
      id: 2,
      ...
      hookline: {
        style:
          "text-left !text-[#E7E7E7] text-[20px] font-[700] leading-[28px] uppercase pb-3",
      },
      description: {
        isVisible: true,
        style:
          "text-left !text-[#E7E7E7] text-[10.24px] font-[500] leading-[16px] tracking-[1.28]  uppercase",
      },
    },
    {
      id: 3,
      ...
      hookline: {
        style:
          "text-center !text-[#000000] text-[20px] font-[700] leading-[28px] pb-3 w-[95%] m-auto",
      },
      description: {
        isVisible: true,
        style:
          "text-center !text-[#000000] text-[10.24px] font-[500] leading-[16px] tracking-[1.28] ",
      },
    },
    {
      id: 4,
      ...
      hookline: {
        style:
          "text-center !text-[#333333] text-[20px] font-[700] leading-[28px]",
      },
      description: {
        isVisible: false,
        style: "",
